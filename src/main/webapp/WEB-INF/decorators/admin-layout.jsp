                ...
                <body>
                    <nav class="topbar">
                        ...
                        <div class="topbar-right">
                            <span class="user-info d-none d-md-block">Xin chao,
                                <strong>${sessionScope.account.fullName}</strong></span>
                    ...
                    <aside class="sidebar" id="sidebar">
                            ...
                            <div class="sidebar-avatar">
                                <c:choose>
                                    <c:when test="${not empty sessionScope.account.avatar}">
                                        <img src="${pageContext.request.contextPath}/img?name=${sessionScope.account.avatar}"
                                            alt="avatar">
                                    </c:when>
                        ...
                        <a href="${pageContext.request.contextPath}/admin/dashboard" class="sidebar-link"><i
                                class="bi bi-grid-1x2-fill"></i> Dashboard</a>
                        <div class="sidebar-section">Quan ly</div>
                        <a href="${pageContext.request.contextPath}/admin/category/list" class="sidebar-link"><i
                                class="bi bi-folder2-open"></i> Danh muc</a>
                        <div class="sidebar-submenu">
                            <a href="${pageContext.request.contextPath}/admin/category/list" class="sidebar-link"><i
                                    class="bi bi-list-ul"></i> Danh sach</a>
                            <a href="${pageContext.request.contextPath}/admin/category/add" class="sidebar-link"><i
                                    class="bi bi-plus-circle"></i> Them moi</a>
                        </div>
                        <a href="${pageContext.request.contextPath}/admin/product/list" class="sidebar-link"><i
                                class="bi bi-box-seam"></i> San pham</a>
                        <div class="sidebar-submenu">
                            <a href="${pageContext.request.contextPath}/admin/product/list" class="sidebar-link"><i
                                    class="bi bi-list-ul"></i> Danh sach</a>
                            <a href="${pageContext.request.contextPath}/admin/product/add" class="sidebar-link"><i
                                    class="bi bi-plus-circle"></i> Them moi</a>
                        </div>
                    ...
                    <main class="main-wrapper">
                        <c:if test="${not empty sessionScope.successMessage}">
                            <div class="toast-success" id="successToast"><i
                                    class="bi bi-check-circle-fill me-2"></i>${sessionScope.successMessage}</div>
