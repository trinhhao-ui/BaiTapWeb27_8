    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <div class="page-heading mb-4">
                <div class="page-title"><i class="bi bi-folder2-open"></i> Quản lý danh mục</div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span><i class="bi bi-list-ul me-2"></i>Danh sách danh mục</span>
                            ...
                            <tbody>
                                <c:choose>
                                    <c:when test="${empty cateList}">
                                        <tr>
                                            <td colspan="4" class="text-center py-5 text-muted">Chưa có danh mục nào
                                            </td>
                                        </tr>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach items="${cateList}" var="cate" varStatus="s">
                                            <tr>
                                                <td>${s.index + 1}</td>
                                                <td>
                                                    <c:choose>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/admin/category/delete?id=${cate.id}"
                                                        ...
                                                        onclick="return confirm('Xác nhận xóa: ${cate.name}?')">
            ...
            <script>
                function searchTable() {
                    ...
                    document.querySelectorAll('#cateTable tbody tr').forEach(r => {
